...
.static(path.join(__dirname,'public','mahi2.jpg')));
app.use('/mahi3',express.static(path.join(__dirname,'public','mahi3.jpg')));
app.use('/video',exp



ress.static(path.join(__dirname,'public','videos.mp4')));
app.use('/panda',express.




static(path.join(__dirname,'public','panda.mp4')));
